...
public record ShipmentResponseDto(
        ...
        @Schema(
                description = "Información del remitente del envío",
                requiredMode = RequiredMode.REQUIRED)
        ShipmentPersonDto sender,

        @Schema(
                description = "Información del destinatario del envío",
                requiredMode = RequiredMode.REQUIRED)
        ShipmentPersonDto recipient,

        @Schema(
                description = "Información de la persona que recibió el envío",
