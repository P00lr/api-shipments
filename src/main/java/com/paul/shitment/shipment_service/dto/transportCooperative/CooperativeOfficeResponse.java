...
@Schema(name = "CooperativeOfficeResponse", description = "DTO que contiene información de una cooperativa con sus oficinas asignadas")
public record CooperativeOfficeResponse(
    ...
    @Schema(
            description = "Lista de oficinas asignadas a la cooperativa",
            requiredMode = RequiredMode.REQUIRED)
